...
use App\Models\SablonModel;

class Sablon extends BaseController
{
    protected $SablonModel;

    public function __construct()
    {
        $this->SablonModel = new SablonModel();
    }
    ...
    public function index()
    {
        ...
        $data['sablon'] = $this->SablonModel->orderBy('no_so', $sortOrder)->findAll();
        $data['userId'] = session()->get('userId');
        $data['userRole'] = session()->get('userRole');

        return view('sablon/index', $data);
    }
    ...
    public function edit($id)
    {
        ...
        $data['sablon'] = $this->SablonModel->find($id);
        return view('sablon/edit', $data);
    }
    ...
    public function update($id)
    {
        ...
        $this->SablonModel->update($id, $data);
    ...
    public function update_status($id)
    {
        ...
        $this->SablonModel->update($id, $data);
        return redirect()->to(base_url('/sablon'));
    }
