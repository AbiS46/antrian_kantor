...
<div class="container-fluid">
    ...
    <h1 class="h3 mb-4 text-gray-800">GALAT</h1>
    ...
    <div class="mb-3">
        <form action="<?= base_url('galat'); ?>" method="get" class="form-inline">
            ...
            <a href="<?= base_url('galat'); ?>" class="btn btn-danger">Hapus Filter</a>
        </form>
    </div>
    ...
    <div class="d-flex justify-content-between align-items-center p-2">
        ...
        <?php if ($userRole === 'Admin'): ?>
            <a href="<?= base_url('galat/create'); ?>" class="btn btn-success mr-4">
            ...
            <tbody>
                ...
                foreach ($galat as $data) : ?>
                    <tr>
                            ...
                            <script>
                                function moveData(selectElement, id) {
                                    ...
                                    if (selectedValue) {
                                        ...
                                        form.action = "<?= base_url('move/galat'); ?>/" + selectedValue + "/" + id; // Update URL sesuai tabel yang dipilih
                        ...
                        <td>
                            <?php if ($userRole === 'Admin'): ?>
                                <a href="<?= base_url('galat/edit/' . $data['id']); ?>" class="btn btn-primary">
                                    <i class="fas fa-solid fa-pen"></i>
                                </a>

                                <a href="<?= base_url('galat/delete/' . $data['id']); ?>" class="btn btn-danger" onclick="return confirmDelete()">
